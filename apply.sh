  ...
  do
    ...
    do
      ...
      do
        ...
        if [[ ${item_name} != System-* && ${item_name} != Syslog* && ${item_tenant_name} != "admin" && ${object_to_remove} != "serviceengine" ]] ; then
